...
function App() {
  ...
  const getSchool = () => {  //学校のお知らせに関するデータベースの処理
    const url = 'https://2120017app1.azurewebsites.net/api/HttpTrigger1?code=Azv1e-WFwEAAy3qt1k1XPV1yr06pBiO-d7K0Rla-Zeq4AzFuJDB5yg==';
  ...
  const getMyclass = () => {  //クラスのお知らせに関するデータベースの処理
    const url = 'https://2120017app1.azurewebsites.net/api/HttpTrigger_c?code=dUMz0tilMD9ycNNq9Sn1EjagNlgpdHLiCSjSoPAt88jxAzFuki6Ffw==';
  ...
  if (isLoaded == false) {  //データベース取得までの表示
    return (
      <div className="center-block text-center loding">
        ...
        <p className="mt-4">時間がかかることがあります<br />しばらくお待ちください</p>
      </div>
    );
  }
      ...
      <BrowserRouter>
        ...
        <Routes>
          <Route path="/" element={<Header />}>
            ...
            <Route path="/home" element={<Home school={school} myclass={myclass} />} />
            ...
            <Route path="/detail1/:id" element={<Detail1 myclass={myclass} />} />
            <Route path="/Home_Teacher" element={<Home_Teacher school={school} myclass={myclass} />} />
            <Route path="/post" element={<Post myclass={myclass} />} />
            <Route path="/postFinish" element={<PostFinish />} />
            <Route path="/loginParent" element={<LoginParent parentslogin={parentslogin} />} />
            <Route path="/loginTeacher" element={<LoginTeacher teacherlogin={teacherlogin} />} />
